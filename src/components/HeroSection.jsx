...
const HeroSection = () => {
  return (
    <div className="z-[2] pointer-events-none flex justify-end flex-col h-[100vh] w-full">
      <h1 className="text-background mr-10 text-[62px] md:text-[100px] font-sans overflow-visible sm:mb-8 mb-50 text-right leading-[100%] md:mb-0">
        <span className="font-display">C</span>lea <br />
        <span className="font-display">P</span>ortolan
      </h1>
      <div className="flex sm:w-[80%] w-full lg:w-[50%] mb-8 md:mb-0">
